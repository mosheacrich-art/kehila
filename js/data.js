...
const MOCK_USERS = [
  {
    ...
    bio: 'Rabino principal de la comunidad Bet El. Especialista en halajá y minhag sefaradí.'
  },
  {
    userId: 'u002',
...
const MOCK_EVENTOS = [
  {
    id: 'ev001',
    titulo: 'Shabat Shalom — Servicio y Cena',
    descripcion: 'Tefila de Kabbalat Shabat seguida de cena comunitaria. Se ruega confirmar asistencia antes del miércoles.',
    fecha: '2024-04-05',
    hora: '19:30',
    lugar: 'Sinagoga Bet El, C/ Balmes 3, Madrid',
    aforo: 80,
    inscritos: 54,
    categoria: 'Shabat',
    organizador: 'Comunidad Bet El',
    emoji: '🕯️'
  },
  {
    id: 'ev002',
    titulo: 'Shiur: Parashat HaShavua',
    descripcion: 'Clase semanal sobre la parashá con el Rabino David Levi. Abierto a toda la comunidad.',
    fecha: '2024-04-03',
    hora: '20:00',
    lugar: 'Sala de estudio — Sinagoga Bet El',
    aforo: 30,
    inscritos: 18,
    categoria: 'Estudio',
    organizador: 'Rabino David Levi',
    emoji: '📖'
  },
  {
    id: 'ev003',
    titulo: 'Pesaj 5784 — Séder Comunitario',
    descripcion: 'Gran séder de Pesaj comunitario. Haggadá bilingüe hebreo-español. Platos tradicionales sefaradíes.',
    fecha: '2024-04-22',
    hora: '20:30',
    lugar: 'Salón del Hotel Meliá Madrid Serrano',
    aforo: 150,
    inscritos: 112,
    categoria: 'Festividad',
    organizador: 'Junta Directiva',
    emoji: '🍷'
  },
  {
    id: 'ev004',
    titulo: 'Clase de Hebreo — Nivel Principiantes',
    descripcion: 'Nuevo ciclo de clases de hebreo moderno. 10 sesiones de 90 minutos. Plazas limitadas.',
    fecha: '2024-04-08',
    hora: '18:00',
    lugar: 'Aula 2 — Centro Comunitario',
    aforo: 20,
    inscritos: 15,
    categoria: 'Educación',
    organizador: 'Rivka Cohen',
    emoji: '🔤'
  },
  {
    id: 'ev005',
    titulo: 'Visita Guiada: Madrid Judío',
    descripcion: 'Recorrido por el antiguo barrio judío de Madrid. Plaza Mayor, Juderías y principales monumentos.',
    fecha: '2024-04-14',
    hora: '11:00',
    lugar: 'Punto de encuentro: Plaza Mayor',
    aforo: 25,
    inscritos: 25,
    categoria: 'Cultura',
  ...
  {
    id: 'ev006',
    titulo: 'Reunión Asamblea General Anual',
    descripcion: 'Presentación de cuentas anuales, proyectos para 5785 y elección de cargos. Voto presencial obligatorio para socios.',
    fecha: '2024-04-28',
    hora: '10:00',
    lugar: 'Sinagoga Bet El — Salón principal',
    aforo: 100,
    inscritos: 43,
    categoria: 'Comunidad',
    organizador: 'Junta Directiva',
...
const MOCK_NOTICIAS = [
  {
    id: 'n001',
    titulo: 'El Rabinato de España emite nueva guía de kashrut para restaurantes',
    categoria: 'Kashrut',
    fecha: '2024-03-28',
    autor: 'Redacción Kehilá',
    resumen: 'El Consejo Rabínico ha publicado una guía actualizada para la certificación kosher en establecimientos de restauración, incorporando nuevos estándares para la supervisión de productos importados.',
    emoji: '📜',
    destacada: true
  },
  {
    id: 'n002',
    titulo: 'Exitosa campaña de recogida de alimentos para Pesaj',
    categoria: 'Comunidad',
    fecha: '2024-03-25',
    autor: 'Miriam Toledano',
    resumen: 'Más de 200 familias se beneficiarán gracias a la campaña Maot Jitim. La comunidad ha superado el objetivo de recaudación en un 40%.',
    emoji: '🤝',
    destacada: false
  },
  {
    id: 'n003',
    titulo: 'Nueva sinagoga inaugurada en Barcelona',
    categoria: 'España',
    fecha: '2024-03-20',
    autor: 'Redacción Kehilá',
    resumen: 'La comunidad Or Jadash de Barcelona inaugura su nueva sede en el Eixample, con capacidad para 200 personas y sala de estudio.',
    emoji: '🏛️',
    destacada: true
  },
  {
    id: 'n004',
    titulo: 'Conferencia sobre el legado sefaradí en Sefarad',
    categoria: 'Cultura',
    fecha: '2024-03-15',
    autor: 'Comité Cultural',
    resumen: 'El 9 de abril se celebra en Madrid un simposio internacional sobre el patrimonio sefaradí, con ponentes de Israel, Turquía y Grecia.',
    emoji: '🎓',
    destacada: false
  },
  {
    id: 'n005',
    titulo: 'Actualización del calendario de festividades 5784',
    categoria: 'Calendario',
    fecha: '2024-03-10',
    autor: 'Secretaría',
    resumen: 'Disponible el calendario completo de festividades del año 5784 con los horarios exactos de comienzo y fin de Shabat para las principales ciudades de España.',
    emoji: '📅',
    destacada: false
  }
];
...
const MOCK_RESTAURANTES = [
  {
    id: 'r001',
    nombre: 'Shalom Madrid',
    tipo: 'Restaurante',
    cocina: 'Mediterránea · Israelí',
    direccion: 'C/ Orfila 6, Madrid',
    telefono: '+34 914 123 456',
    certificacion: 'MK Madrid · Glatt',
    horario: 'Mar-Dom 13:00-16:00 / 20:00-23:00',
    cierra: 'Lunes y Shabat',
    ciudad: 'Madrid',
    emoji: '🍽️',
    rating: 4.7
  },
  {
    id: 'r002',
    nombre: 'Café Yerushalaim',
    tipo: 'Cafetería',
    cocina: 'Israelí · Desayunos',
    direccion: 'C/ Serrano 41, Madrid',
    telefono: '+34 914 567 890',
    certificacion: 'MK Madrid · Chalav Israel',
    horario: 'Lun-Vie 08:00-20:00 / Dom 09:00-15:00',
    cierra: 'Sábados',
    ciudad: 'Madrid',
    emoji: '☕',
    rating: 4.5
  ...
  {
    id: 'r003',
    nombre: 'La Taverna Kosher',
    tipo: 'Restaurante',
    cocina: 'Sefaradí · Española',
    direccion: 'C/ Sant Antoni M. Claret 28, Barcelona',
    telefono: '+34 932 345 678',
    certificacion: 'Vaad Barcelona',
    horario: 'Mar-Jue 13:00-22:00 / Vie 13:00-15:00',
    cierra: 'Lunes, Sábados y Domingos',
    ciudad: 'Barcelona',
    emoji: '🥘',
    rating: 4.6
  },
  {
    id: 'r004',
    nombre: 'Tel Aviv Street Food',
    tipo: 'Comida rápida',
    cocina: 'Israelí · Street food',
    direccion: 'Av. Diagonal 200, Barcelona',
    telefono: '+34 932 987 654',
    certificacion: 'Vaad Barcelona · Parve',
  ...
  {
    id: 'r005',
    nombre: 'Marbella Kosher Grill',
    tipo: 'Restaurante',
    cocina: 'Parrilla · Mediterránea',
    direccion: 'Puerto Banús, Local 14, Marbella',
    telefono: '+34 952 111 222',
    certificacion: 'MK Málaga · Glatt',
    horario: 'Lun-Dom 13:00-24:00',
    cierra: 'Shabat (abre Motzei Shabat)',
    ciudad: 'Marbella',
    emoji: '🥩',
    rating: 4.8
  },
  {
    id: 'r006',
    nombre: 'Rosh Pina — Catering y Eventos',
    tipo: 'Catering',
    cocina: 'Asquenazí · Sefaradí · Eventos',
    direccion: 'C/ Gran Vía 48, Madrid',
    telefono: '+34 915 333 444',
    certificacion: 'MK Madrid · Glatt Bet Yosef',
    horario: 'Consultar disponibilidad',
    cierra: 'Shabat y festivos judíos',
    ciudad: 'Madrid',
    emoji: '🎊',
    rating: 4.9
  }
...
const MOCK_DONATIVOS = [
  {
    id: 'd001',
    titulo: 'Maot Jitim 5784 — Pesaj para todos',
    descripcion: 'Aseguramos que cada familia de la comunidad pueda celebrar Pesaj con dignidad. Los fondos se destinan a la compra de alimentos kosher para Pesaj y distribución a familias con necesidades.',
    objetivo: 8000,
    recaudado: 6240,
    donantes: 87,
    fechaFin: '2024-04-15',
    organizador: 'Comité de Tzedaká',
    urgente: true,
    categoria: 'Tzedaká',
    emoji: '🍷'
  },
  {
    id: 'd002',
    titulo: 'Renovación del Aron Hakodesh',
    descripcion: 'El Aron Hakodesh de nuestra sinagoga tiene más de 40 años y necesita una restauración completa. Queremos dotar a nuestra comunidad de un espacio digno para los Sifrei Torá.',
    objetivo: 15000,
    recaudado: 9750,
    donantes: 52,
    fechaFin: '2024-06-30',
  ...
  {
    id: 'd003',
    titulo: 'Becas Talmud Torá 5784-5785',
    descripcion: 'Financiamos becas para que ningún niño de la comunidad se quede sin educación judía por razones económicas. El 100% de los fondos va directamente a las familias beneficiarias.',
    objetivo: 12000,
    recaudado: 4800,
    donantes: 34,
    fechaFin: '2024-08-31',
    organizador: 'Comité de Educación',
    urgente: false,
    categoria: 'Educación',
    emoji: '📚'
  }
...
const MOCK_PREGUNTAS = [
  {
    ...
    respondidoPor: 'Rabino David Levi',
...
const MOCK_SHIURIM_V2 = [
  ...
  { id:'sv10', titulo:'Kipur: el día más sagrado del año', maestro:'HaRav Yosef Cohen', categoria:'Yamim Noraim', formato:'Audio', duracion:'70 min', nivel:1, fecha:'2024-02-20', descripcion:'Yom Kipur no es solo un día de ayuno — es la culminación del proceso de teshuvá, el momento más elevado del calendario judío. El Rav Cohen explica el significado del Kol Nidré, el Neila y cómo prepararse para salir del día transformados.' }
];

const DEVAR_TORAH = [
  { id:'dt01', texto:'El Shabat no es solo descanso del cuerpo — es el alma del tiempo. Cada semana, Dios nos regala 25 horas para recordar quiénes somos.', firma:'HaRav Yosef Cohen', parasha:'Parashat Vayikrá', fecha:'2024-03-28' },
  ...
  { id:'dt05', texto:'Un hombre que trabaja sobre su carácter hace más por el mundo que mil que predican sin practicar. El Musar comienza en el espejo, no en el púlpito.', firma:'HaRav Yosef Cohen', parasha:'Parashat Metzorá', fecha:'2024-02-29' }
];
...
const MOCK_TENYAD = [
  { id:'ty01', nombre:'Set de sillas plegables (x20)', categoria:'Sillas/Mesas', descripcion:'20 sillas plegables blancas en buen estado. Perfectas para eventos y reuniones.', condicion:'Bueno', propietario:'Comunidad Bet El', anonimo:false, disponible:true, hasta:null, icono:'🪑' },
  ...
  { id:'ty06', nombre:'Menorá para Janucá (grande)', categoria:'Decoración Fiestas', descripcion:'Janukiá grande de metal dorado, 50cm. Perfecta para eventos comunitarios. Incluye portavelas.', condicion:'Excelente', propietario:'Comunidad Bet El', anonimo:false, disponible:true, hasta:null, icono:'🕎' },
...
const MOCK_TALMUD_TORAH = [
  ...
  { id:'tt03', grupo:'Clase Guimel', edades:'11-13 años', maestro:'Rabino David Levi', horario:'Domingos 11:00-13:30 · Martes 17:30-19:30', aula:'Sala de estudio', plazas:12, inscritos:9, color:'#FFF8E1' },
  { id:'tt04', grupo:'Bnei Mitzvá', edades:'12-13 años', maestro:'Rabino David Levi', horario:'Lunes y Jueves 17:00-19:00 · Domingo 12:00-13:30', aula:'Despacho del Rav', plazas:6, inscritos:4, color:'#FCE4EC' }
];
...
const MOCK_TT_MENSAJES = [
  ...
  { clase:'Clase Guimel', maestro:'Rabino David Levi', mensaje:'Excelente trabajo con el estudio de Pirkei Avot. La semana que viene empezamos Mishná Berajot. Os dejo material de preparación en el grupo.', fecha:'2024-03-22' },
  { clase:'Bnei Mitzvá', maestro:'Rabino David Levi', mensaje:'Yosef ya domina su parashá. Moshe y Avi, necesitamos reforzar las notas altas del tropo. Quedamos el martes extra a las 16:30.', fecha:'2024-03-20' },
...
const MOCK_LIBROS = [
  ...
  { id:'l5', titulo:'Cuentos del Baal Shem Tov', autor:'Sifrei Hasidim', editorial:'Kehilá Ed.', categoria:'Infantil', idioma:'ES', precio:15.00, badge:'nuevo', portadaColor:'#1B2E5E' },
...
const MOCK_NOTICIAS_V2 = [
  {
    ...
    excerpt: 'La comunidad Kehilá ha organizado este año una guía completa para la preparación de Pesaj: bedikat jametz, venta del jametz, horarios del Séder comunitario y lista actualizada de productos kosher le-Pesaj disponibles en España.',
