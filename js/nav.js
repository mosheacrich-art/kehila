...
const BOTTOM_NAV_ITEMS = [
  ...
  { id: 'comunidad',  href: 'jconnect.html',  icon: NAV_ITEMS[1].items[2].icon },
];
...
function buildSidebar(activePage) {
  ...
  const NAV_KEYS = {
    ...
    esencial: 'nav_esencial', perfil: 'nav_perfil', galeria: 'nav_galeria'
  };
  const GROUP_KEYS = {
